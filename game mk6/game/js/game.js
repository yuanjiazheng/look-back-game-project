class Game {
    ...
    initGame() {
        ...
        //创建难民小屋
        this.RufugeeHouse = new RufugeeHouse(MAP_WIDTH / 2 + 200, GROUND_Y-50, this.resourceManager);
        this.RufugeeHouse.setgame(this);
    ...
    update(deltaTime) {
        ...
        //更新难民小屋
        this.RufugeeHouse.update(deltaTime);
        ...
        this.tree = new Tree(MAP_WIDTH / 2 - 100, GROUND_Y - 85, this.resourceManager);
        this.hitboxSystem.registerEntity(this.tree);
    ...
    render() {
        ...
        this.tree.draw(this.ctx, this.camera);
