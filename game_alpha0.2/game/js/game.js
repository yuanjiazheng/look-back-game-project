class Game {
    ...
    async loadResources() {
        ...
        this.resourceManager.addResource('Arrow', 'image', 'image/Arrow/Arrow.png');
        // 添加其他资源...
    ...
    initGame() {
        ...
        //创建弓商店
        this.bowstore = new BowStore(MAP_WIDTH / 2+300, GROUND_Y-50, this.resourceManager);
        this.EntityManager.addEntity(this.bowstore,this.bowstore.type);

        //创建锤子商店
        this.hammerstore = new HammerStore(MAP_WIDTH / 2-300, GROUND_Y-50, this.resourceManager);
        this.EntityManager.addEntity(this.hammerstore,this.hammerstore.type);

        //创建墙
        this.wallR1 = new Wall(MAP_WIDTH / 2+600, GROUND_Y-80, this.resourceManager);
        this.EntityManager.addEntity(this.wallR1,this.wallR1.type);

        this.wallL1 = new Wall(MAP_WIDTH / 2-600, GROUND_Y-80, this.resourceManager);
        this.EntityManager.addEntity(this.wallL1,this.wallL1.type);
        ...
        // 创建玩家 - 传递资源管理器
        this.twistzz= new Twistzz(MAP_WIDTH / 2 + 50, GROUND_Y-80, this.resourceManager);
        this.EntityManager.addEntity(this.twistzz,this.twistzz.type);
        ...
        // this.enemy = new Enemy(MAP_WIDTH / 2 + 700, GROUND_Y-45, this.resourceManager);
